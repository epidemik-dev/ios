...
extension MKMapView {
	//The extension to the map with a few auxiliary functions
	
	//Returns the zoom level of the map (between 1 and about 15)
	...
	//Adjusts the map so the center is where you give and it is at the specified zoom level
	//EFFECT: changes the view of the map
